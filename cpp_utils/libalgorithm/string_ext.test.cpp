#include "cpp_utils/libalgorithm/string_ext.hpp"
#include <gmock/gmock.h>

using cpp_utils::algorithm::endsWith;
using cpp_utils::algorithm::join;
using cpp_utils::algorithm::parseWords;
using cpp_utils::algorithm::split;
using cpp_utils::algorithm::startsWith;
